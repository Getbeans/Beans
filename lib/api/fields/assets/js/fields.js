    ...
    beansFields.prototype = {
        ...
        slider: function( selector ) {
            ...
            selector.slider({
                ...
                slide: function( event, ui ) {
	                ...
	                // Update text hidden input.  Then trigger the change.
	                var sliderField = $(this).find( 'input[type=text]' );
	                sliderField.val( ui.value );
	                sliderField.trigger( 'change' );
                }
            });
        ...
        activation: function( selector ) {
            ...
            if ( selector.is( ':checked' ) ) {
                selector.parent().next().removeClass( 'deactivated' );
            } else {
                selector.parent().next().addClass( 'deactivated' );
            }
        },
