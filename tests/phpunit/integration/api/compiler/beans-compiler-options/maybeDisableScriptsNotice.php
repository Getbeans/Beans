...
class Tests_BeansCompilerOptions_MaybeDisableScriptsNotice extends Compiler_Options_Test_Case {
	...
	/**
	 * Test _Beans_Compiler_Options::maybe_disable_scripts_notice() should not render when compile scripts not an
	 * option.
	 */
	...
	/**
	 * Test _Beans_Compiler_Options::maybe_disable_scripts_notice() should render when compile scripts is selected and
