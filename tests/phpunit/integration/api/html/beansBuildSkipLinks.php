...
class Tests_BeansBuildSkipLinks extends HTML_Test_Case {
	...
	public function test_should_not_output_sidebar_skip_links_when_layout_c_selected() {
		...
		$expected = <<<EOB
<ul class="beans-skip-links"><li ><a href="#beans-content" class="screen-reader-shortcut">Skip to the content.</a></li></ul>
EOB;
		ob_start();
	...
	public function test_should_output_content_primary_sidebar_skip_links() {
		...
		$expected = <<<EOB
<ul class="beans-skip-links"><li ><a href="#beans-content" class="screen-reader-shortcut">Skip to the content.</a></li><li ><a href="#beans-primary-sidebar" class="screen-reader-shortcut">Skip to the primary sidebar.</a></li></ul>
EOB;
		ob_start();
		beans_build_skip_links();
		$actual = ob_get_clean();
	...
	public function test_should_output_content_secondary_sidebar_skip_links() {
		...
		$expected = <<<EOB
<ul class="beans-skip-links"><li ><a href="#beans-content" class="screen-reader-shortcut">Skip to the content.</a></li><li ><a href="#beans-secondary-sidebar" class="screen-reader-shortcut">Skip to the secondary sidebar.</a></li></ul>
EOB;
		ob_start();
		beans_build_skip_links();
		$actual = ob_get_clean();
	...
	public function test_should_output_content_both_sidebar_skip_links() {
		...
		$expected = <<<EOB
<ul class="beans-skip-links"><li ><a href="#beans-content" class="screen-reader-shortcut">Skip to the content.</a></li><li ><a href="#beans-primary-sidebar" class="screen-reader-shortcut">Skip to the primary sidebar.</a></li><li ><a href="#beans-secondary-sidebar" class="screen-reader-shortcut">Skip to the secondary sidebar.</a></li></ul>
EOB;
		ob_start();
		beans_build_skip_links();
		$actual = ob_get_clean();
...
EOB;
	...
	public function test_should_output_primary_navigation_content_and_both_sidebar_skip_links() {
		...
		$expected = <<<EOB
<ul class="beans-skip-links"><li ><a href="#beans-primary-navigation" class="screen-reader-shortcut">Skip to the primary navigation.</a></li><li ><a href="#beans-content" class="screen-reader-shortcut">Skip to the content.</a></li><li ><a href="#beans-primary-sidebar" class="screen-reader-shortcut">Skip to the primary sidebar.</a></li><li ><a href="#beans-secondary-sidebar" class="screen-reader-shortcut">Skip to the secondary sidebar.</a></li></ul>
EOB;
		ob_start();
		beans_build_skip_links();
		$actual = ob_get_clean();
