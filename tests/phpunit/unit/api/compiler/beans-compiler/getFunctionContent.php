...
class Tests_Beans_Compiler_Get_Function_Content extends Compiler_Test_Case {
	...
	/**
	 * Test get_function_content() should return content from function.
	 */
	public function test_should_return_return_content_from_function() {
	 ...
	 */
	public function test_should_return_return_content_from_method() {
		$compiler = new \_Beans_Compiler( array() );
