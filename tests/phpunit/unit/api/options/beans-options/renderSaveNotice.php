<?php
/**
 * Tests for render_save_notice() method of the _Beans_Options.
 *
...
/**
 * Class Tests_Beans_Options_Render_Save_Notice
 *
 * @package Beans\Framework\Tests\Unit\API\Options
 * @group   api
 * @group   api-options
 */
class Tests_Beans_Options_Render_Save_Notice extends Options_Test_Case {

	/**
	 * Test save_notices() should render the error message when the "success" property is not set.
	 */
...
EOB;
	...
	/**
	 * Test save_notices() should render the updated message when the "success" property is set.
	 */
