...
class Tests_Beans_Options_Render_Save_Notice extends Options_Test_Case {
	...
	/**
	 * Test save_notices() should render error message when "success" property is not set.
	 */
...
EOB;
	...
	/**
	 * Test save_notices() should render updated message when "success" property is set.
	 */
