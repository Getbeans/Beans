...
class Tests_BeansLoadDefaultTemplate extends Template_Test_Case {
	...
	/**
	 * Test beans_load_default_template() should return false when structure template does not exist.
	 */
	...
	/**
	 * Test beans_load_default_template() should load the template when the given structure has an invalid path.
	 */
